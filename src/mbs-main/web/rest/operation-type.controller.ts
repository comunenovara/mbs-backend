...
export class OperationTypeController {
    ...
    createOperationType(@Body() operationTypeDto: OperationTypeDto) {
        ...
        return this.operationTypeBusinessService.addOperationType(operationTypeDto);
    }
    ...
    getAllOperationTypes(@Query() queryParams): Promise<any> {
        return this.operationTypeBusinessService.getOperationTypes(queryParams);
    }
    ...
    getOperationTypesCount(@Query() queryParams): Promise<number> {
        return this.operationTypeBusinessService.countOperationTypes(queryParams);
    }
